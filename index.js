...
var debug = require('debug')('js-pipeline.input.Cradle');
var debug_events = require('debug')('js-pipeline.input.Cradle:Events');
var debug_internals = require('debug')('js-pipeline.input.Cradle:Internals');
